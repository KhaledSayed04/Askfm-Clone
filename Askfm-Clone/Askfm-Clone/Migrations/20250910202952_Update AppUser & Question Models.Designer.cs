...
namespace Askfm_Clone.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the EF Core target model for the migration "20250910202952_Update AppUser & Question Models".
        /// </summary>
        /// <remarks>
        /// Applies the entity and table mappings, property configurations (types, defaults, generated values), primary and composite keys,
        /// indexes, relationships (including delete behaviors), and navigation properties that represent the model snapshot for this migration.
        /// This method is used by EF Core's migrations infrastructure and is not intended for direct application logic.
        /// </remarks>
