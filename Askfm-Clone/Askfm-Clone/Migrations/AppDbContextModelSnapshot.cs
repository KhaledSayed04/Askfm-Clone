...
namespace Askfm_Clone.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the EF Core model used by migrations for the AppDbContext.
        /// </summary>
        /// <remarks>
        /// Defines entity mappings, keys, indices, relationships, table names, and provider-specific annotations
        /// for all domain entities (Answer, AppUser, Block, CoinsTransaction, Comment, Follow, Like, Question,
        /// QuestionRecipient, RefreshTokenInfo) as part of the model snapshot.
        /// </remarks>
